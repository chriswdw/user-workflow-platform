...
/**
 * isComplete() gates whether a draft submission can move to submit-for-approval — it is pure
 * logic with a real business meaning (a submission needs both a blotter and detail view config
 * before it's reviewable), so every short-circuit branch is covered directly.
 */
