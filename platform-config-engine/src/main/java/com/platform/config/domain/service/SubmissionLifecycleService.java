...
public class SubmissionLifecycleService
    implements ISubmitForApprovalUseCase, IReviseSubmissionUseCase {
  ...
  public SubmissionLifecycleService(
      IWorkflowTypeSubmissionRepository repo, IAuditRepository auditRepo) {
    this.repo = repo;
  ...
  public WorkflowTypeSubmission revise(
    ...
    auditRepo.save(
        SubmissionGuards.submissionAuditEntry(
            saved, AuditEventType.SUBMISSION_REVISED, "REJECTED", "DRAFT", actorUserId));
    return saved;
  }
