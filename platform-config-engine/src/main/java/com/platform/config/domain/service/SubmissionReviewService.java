...
public class SubmissionReviewService implements IReviewSubmissionUseCase {
    ...
    public SubmissionReviewService(IWorkflowTypeSubmissionRepository repo,
    ...
    public WorkflowTypeSubmission reject(String tenantId, String submissionId,
        ...
        WorkflowTypeSubmission saved = repo.save(new WorkflowTypeSubmission(
                ...
                submission.version() + 1,
                submission.createdAt(), now));
        auditRepo.save(SubmissionGuards.submissionAuditEntry(saved, AuditEventType.SUBMISSION_REJECTED,
