...
/**
 * Input port: load the single active config document for a given tenant, workflowType, and config
 * type. Throws ConfigNotFoundException if none is active. Throws ConfigIntegrityException if more
 * than one is active (domain invariant violated).
 */
