...
public class SubmissionCreationService implements ICreateWorkflowTypeSubmissionUseCase {
    ...
    public SubmissionCreationService(IWorkflowTypeSubmissionRepository repo,
    ...
    public WorkflowTypeSubmission create(CreateSubmissionCommand command) {
        ...
        auditRepo.save(SubmissionGuards.submissionAuditEntry(saved, AuditEventType.SUBMISSION_CREATED,
    ...
    private WorkflowTypeSubmission autoApprove(WorkflowTypeSubmission submission, String actorUserId) {
        ...
        auditRepo.save(SubmissionGuards.submissionAuditEntry(saved, AuditEventType.SUBMISSION_APPROVED,
