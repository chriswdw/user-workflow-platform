...
/**
 * In-memory test double for IRoutingConfigRepository. Used by Cucumber step definitions to seed
 * routing config without a database.
 */
public class InMemoryRoutingConfigRepository implements IRoutingConfigRepository {
  ...
  @Override
  public Optional<RoutingConfig> findActiveByTenantAndWorkflowType(
      String tenantId, String workflowType) {
