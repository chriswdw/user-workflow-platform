...
/**
 * Output port: retrieves the active routing configuration for a workflow type. Implemented by the
 * PostgreSQL adapter in production; by InMemoryRoutingConfigRepository in tests.
 */
