...
/**
 * Input port: execute a named workflow transition on a work item. Returns the updated WorkItem
 * after the transition. Throws ForbiddenTransitionException, InvalidTransitionException, or
 * ValidationFailedException on failure.
 */
