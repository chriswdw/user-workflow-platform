...
/**
 * Outcome of an ingest operation. All expected business outcomes are modelled here; only unexpected
 * system errors (missing config, repository failure) throw exceptions.
 */
public sealed interface IngestionResult
    permits IngestionResult.Created, IngestionResult.Duplicate, IngestionResult.Rejected {
