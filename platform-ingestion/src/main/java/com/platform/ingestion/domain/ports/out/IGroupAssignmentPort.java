...
/**
 * Output port: assign a resolution group to a work item based on routing rules. In production,
 * delegates to platform-routing's IRouteWorkItemUseCase. In tests, the in-memory double returns a
 * preconfigured group.
 */
