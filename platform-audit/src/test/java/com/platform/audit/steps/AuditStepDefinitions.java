...
public class AuditStepDefinitions {
  ...
  public void entryAppendedAt(String eventType, String workItemId, String timestamp) {
    auditService.append(
        entry(workItemId, AuditEventType.valueOf(eventType), Instant.parse(timestamp)));
  }
  ...
  public void trailQueriedByRange(String workItemId, String from, String to) {
    queryResult =
        auditService.query(
            new AuditQuery(tenantId, workItemId, null, Instant.parse(from), Instant.parse(to)));
  }
