...
/**
 * Resolves dot-notation field paths against a nested Map representing WorkItem.fields. Used by the
 * routing rule evaluator, blotter renderer, and audit log to access arbitrary-depth fields without
 * knowing the structure at compile time.
 *
 * <p>Example: resolve(fields, "trade.notionalAmount.amount") navigates
