...
class IngestionConfigJdbcRepositoryTest {
  ...
  void findByTenantAndWorkflowTypeAndSourceType_returnsEmptyWhenNoneConfigured() {
    Optional<IngestionConfig> result =
        repository.findByTenantAndWorkflowTypeAndSourceType(
  ...
  void findByTenantAndWorkflowTypeAndSourceType_doesNotCrossSourceTypeBoundary() {
    ...
    assertThat(
            repository.findByTenantAndWorkflowTypeAndSourceType(
                "tenant-1", "SETTLEMENT_EXCEPTION", SourceType.FILE_UPLOAD))
        .isEmpty();
  }
  ...
  void findByTenantAndWorkflowTypeAndSourceType_doesNotCrossTenantBoundary() {
    ...
    assertThat(
            repository.findByTenantAndWorkflowTypeAndSourceType(
                "tenant-B", "SETTLEMENT_EXCEPTION", SourceType.KAFKA))
        .isEmpty();
  }
  ...
  private static void insertIngestionConfig(
      String tenantId,
      String workflowType,
      String sourceType,
