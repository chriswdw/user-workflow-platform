...
class SaveDraftRequestTest {
  ...
  void currentStepBelowOneIsClampedToOne() {
    SaveDraftRequest request =
        new SaveDraftRequest(new DraftConfigs(null, null, null, null, null, null), 0);
  ...
  void currentStepAtOrAboveOneIsUnchanged() {
    SaveDraftRequest request =
        new SaveDraftRequest(new DraftConfigs(null, null, null, null, null, null), 3);
  ...
  void providedDraftConfigsIsUsedAsIs() {
    DraftConfigs draftConfigs =
        new DraftConfigs(null, null, null, null, java.util.Map.of("a", 1), null);
