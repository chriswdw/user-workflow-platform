...
/**
 * Starts a single embedded PostgreSQL instance per JVM and runs Liquibase migrations once. Shared
 * across all JDBC repository integration tests to keep total setup time low.
 */
