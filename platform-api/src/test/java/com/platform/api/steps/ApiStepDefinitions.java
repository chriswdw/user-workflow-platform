...
public class ApiStepDefinitions {
  ...
  @Given(
      "a draft submission {string} exists for tenant {string} workflow type {string} submitted by {string}")
  public void draftSubmissionExists(
      String id, String tenantId, String workflowType, String submittedBy) {
    OffsetDateTime now = OffsetDateTime.now(ZoneOffset.UTC);
    submissionStore.seed(
  ...
  @Given(
      "a complete draft submission {string} exists for tenant {string} workflow type {string} submitted by {string}")
  public void completeDraftSubmissionExists(
      String id, String tenantId, String workflowType, String submittedBy) {
    OffsetDateTime now = OffsetDateTime.now(ZoneOffset.UTC);
    submissionStore.seed(
        new WorkflowTypeSubmission(
  ...
  @Given(
      "a pending submission {string} exists for tenant {string} workflow type {string} submitted by {string}")
  public void pendingSubmissionExists(
      String id, String tenantId, String workflowType, String submittedBy) {
  ...
  @Given(
      "a rejected submission {string} exists for tenant {string} workflow type {string} submitted by {string}")
  public void rejectedSubmissionExists(
      String id, String tenantId, String workflowType, String submittedBy) {
  ...
  public void sourceConnectionExists(String id, String type) {
    ...
    sourceConnectionStore.putConnection(
        new SourceConnection(
            id, id, id + " Display", connectionType, config, null, "admin", now, now));
  }
