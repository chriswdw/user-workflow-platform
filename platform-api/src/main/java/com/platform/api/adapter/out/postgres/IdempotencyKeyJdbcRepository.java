...
/**
 * Checks idempotency against the work_items table's existing unique index on (tenant_id,
 * workflow_type, idempotency_key). No separate table is needed. save() is a no-op: the key is
 * persisted as part of the WorkItem INSERT.
 */
