...
public class IngestionConfigJdbcRepository implements IIngestionConfigRepository {
  ...
  public Optional<IngestionConfig> findByTenantAndWorkflowTypeAndSourceType(
    ...
    return jdbc.query(sql, params, (rs, n) -> parseContent(rs.getString("content"))).stream()
        .findFirst();
  }
  ...
  private IngestionConfig parseContent(String json) {
    try {
      ...
      List<Map<String, Object>> rawMappings =
          (List<Map<String, Object>>) m.getOrDefault("fieldMappings", List.of());
      ...
      List<String> idempotencyKeyFields =
          (List<String>) m.getOrDefault("idempotencyKeyFields", List.of());
      return new IngestionConfig(
          ...
          IdempotencyKeyStrategy.valueOf(
              (String) m.getOrDefault("idempotencyKeyStrategy", "EXPLICIT_FIELD")),
