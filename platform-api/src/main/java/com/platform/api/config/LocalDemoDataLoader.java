...
public class LocalDemoDataLoader {
  ...
  private void insertWorkItems(
      NamedParameterJdbcTemplate jdbc, ObjectMapper mapper, OffsetDateTime now) {
    String sql =
        """
        ...
        new DemoItem(
            ...
            Map.of(
                ...
                Map.of(
                    ...
                    FIELD_VALUE_DATE,
                    "2024-10-17",
                    FIELD_NOTIONAL_AMOUNT,
                    Map.of(FIELD_AMOUNT, "15000000.00", FIELD_CURRENCY, "GBP")),
                FIELD_COUNTERPARTY,
                Map.of("name", "Barclays Capital", "lei", "G5GSEF7VJP5I7OUK5573"))),
        new DemoItem(
            "wi-002",
            SOURCE_KAFKA,
            STATUS_UNDER_REVIEW,
            ...
            Map.of(
                ...
                Map.of(
                    ...
                    "2024-10-18",
                    FIELD_NOTIONAL_AMOUNT,
                    Map.of(FIELD_AMOUNT, "2500000.00", FIELD_CURRENCY, "EUR")),
                FIELD_COUNTERPARTY,
                Map.of("name", "Deutsche Bank AG", "lei", "7LTWFZYICNSX8D621K86"))),
        new DemoItem(
            WI_003,
            "DB_POLL",
            STATUS_ESCALATED,
            ...
            Map.of(
                ...
                Map.of(
                    ...
                    "2024-10-15",
                    FIELD_NOTIONAL_AMOUNT,
                    Map.of(FIELD_AMOUNT, "50000000.00", FIELD_CURRENCY, "USD")),
                FIELD_COUNTERPARTY,
                Map.of("name", "JP Morgan Chase", "lei", "8I5DZWZKVSZI1NUHU748"))),
        new DemoItem(
            "wi-004",
            "FILE_UPLOAD",
            "CLOSED",
            ...
            Map.of(
                ...
                Map.of(
                    ...
                    "2024-10-14",
                    FIELD_NOTIONAL_AMOUNT,
                    Map.of(FIELD_AMOUNT, "175000.00", FIELD_CURRENCY, "GBP")),
                FIELD_COUNTERPARTY,
                Map.of("name", "HSBC Holdings", "lei", "MLU0ZO3ML4LN2LL2TL39"))),
        new DemoItem(
            "wi-005",
            SOURCE_KAFKA,
            STATUS_UNDER_REVIEW,
            ...
            Map.of(
                ...
                Map.of(
                    ...
                    "2024-10-20",
                    FIELD_NOTIONAL_AMOUNT,
                    Map.of(FIELD_AMOUNT, "8750000.00", FIELD_CURRENCY, "CHF")),
                FIELD_COUNTERPARTY,
                Map.of("name", "UBS Group AG", "lei", "BFM8T61CT2L1QCEMIK50"))));
  }
